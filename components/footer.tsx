...
const Footer = () => {
    return (<footer className="bg-white border-t py-6">
        <div
            className="h-6 md:h-6 flex flex-col md:flex-row items-center justify-center md:justify-between px-4 sm:px-6 lg:px-8 max-w-7xl">
            ...
            <div className="absolute right-0 px-4 sm:px-6 lg:px-8">
                <Button
                    onClick={() => window.open('https://github.com/Meirbek-dev/sunshine-store-admin', '_blank')}
